...
### Deterministic — Whole (`audit/deterministic/document/04-feature.yaml`)
...
### Semantic — Whole (`audit/semantic/document/04-feature.md`)
...
### Deterministic — Section (`audit/deterministic/section/04-feature/*.yaml`)
...
### Semantic — Section (`audit/semantic/section/04-feature/*.md`)
...
| Report | File |
|---|---|
| Deterministic — Whole | `{{ det_whole_report_path }}` (`audit/deterministic/document/04-feature.yaml`) |
| Deterministic — Section | `{{ det_section_report_path }}` (`audit/deterministic/section/04-feature/*.yaml`) |
| Semantic — Whole | `{{ sem_whole_report_path }}` (`audit/semantic/document/04-feature.md`) |
| Semantic — Section | `{{ sem_section_report_path }}` (`audit/semantic/section/04-feature/*.md`) |
