...
### Deterministic — Whole (`audit/deterministic/document/06-design.yaml`)
...
### Semantic — Whole (`audit/semantic/document/06-design.md`)
...
### Deterministic — Section (`audit/deterministic/section/06-design/*.yaml`)

| # | Section | Required | Score | Previous | Trend |
|---:|---|:---:|---:|---:|---|
| 1 | Design Principles | **required** | {{ sections.design_principles.det_score }} / 100 | {{ sections.design_principles.det_previous_score | default('—') }} | {{ sections.design_principles.det_trend_display }} |
| 2 | UX Principles | **required** | {{ sections.ux_principles.det_score }} / 100 | {{ sections.ux_principles.det_previous_score | default('—') }} | {{ sections.ux_principles.det_trend_display }} |
| 3 | Accessibility | **required** | {{ sections.accessibility.det_score }} / 100 | {{ sections.accessibility.det_previous_score | default('—') }} | {{ sections.accessibility.det_trend_display }} |
...
### Semantic — Section (`audit/semantic/section/06-design/*.md`)

| # | Section | Required | Score | Previous | Trend |
|---:|---|:---:|---:|---:|---|
| 1 | Design Principles | **required** | {{ sections.design_principles.sem_score }} / 100 | {{ sections.design_principles.sem_previous_score | default('—') }} | {{ sections.design_principles.sem_trend_display }} |
| 2 | UX Principles | **required** | {{ sections.ux_principles.sem_score }} / 100 | {{ sections.ux_principles.sem_previous_score | default('—') }} | {{ sections.ux_principles.sem_trend_display }} |
| 3 | Accessibility | **required** | {{ sections.accessibility.sem_score }} / 100 | {{ sections.accessibility.sem_previous_score | default('—') }} | {{ sections.accessibility.sem_trend_display }} |
...
| Report | File |
|---|---|
| Deterministic — Whole | `{{ det_whole_report_path }}` (`audit/deterministic/document/06-design.yaml`) |
| Deterministic — Section | `{{ det_section_report_path }}` (`audit/deterministic/section/06-design/*.yaml`) |
| Semantic — Whole | `{{ sem_whole_report_path }}` (`audit/semantic/document/06-design.md`) |
| Semantic — Section | `{{ sem_section_report_path }}` (`audit/semantic/section/06-design/*.md`) |
