...
### Deterministic — Whole (`audit/deterministic/document/07-engineering.yaml`)
...
### Semantic — Whole (`audit/semantic/document/07-engineering.md`)
...
### Deterministic — Section (`audit/deterministic/section/07-engineering/*.yaml`)
...
### Semantic — Section (`audit/semantic/section/07-engineering/*.md`)
...
| Report | File |
|---|---|
| Deterministic — Whole | `{{ det_whole_report_path }}` (`audit/deterministic/document/07-engineering.yaml`) |
| Deterministic — Section | `{{ det_section_report_path }}` (`audit/deterministic/section/07-engineering/*.yaml`) |
| Semantic — Whole | `{{ sem_whole_report_path }}` (`audit/semantic/document/07-engineering.md`) |
| Semantic — Section | `{{ sem_section_report_path }}` (`audit/semantic/section/07-engineering/*.md`) |
