...
### Deterministic — Whole (`audit/deterministic/document/08-external-context.yaml`)
...
### Semantic — Whole (`audit/semantic/document/08-external-context.md`)
...
### Deterministic — Section (`audit/deterministic/section/08-external-context/*.yaml`)
...
### Semantic — Section (`audit/semantic/section/08-external-context/*.md`)
...
| Report | File |
|---|---|
| Deterministic — Whole | `{{ det_whole_report_path }}` (`audit/deterministic/document/08-external-context.yaml`) |
| Deterministic — Section | `{{ det_section_report_path }}` (`audit/deterministic/section/08-external-context/*.yaml`) |
| Semantic — Whole | `{{ sem_whole_report_path }}` (`audit/semantic/document/08-external-context.md`) |
| Semantic — Section | `{{ sem_section_report_path }}` (`audit/semantic/section/08-external-context/*.md`) |
