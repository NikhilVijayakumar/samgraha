...
### Deterministic — Whole (`audit/deterministic/document/11-prototype.yaml`)
...
| Mock Fidelity | {{ categories.mock_fidelity.score }} / 100 | {{ categories.mock_fidelity.previous_score | default('—') }} | {{ categories.mock_fidelity.trend_display }} |
...
### Semantic — Whole (`audit/semantic/document/11-prototype.md`)

| Criterion | Result | Previous | Trend |
|---|---|---|---|
| C1 — Mock/Data Model consistency | {{ doc_semantic.c1_display }} | {{ doc_semantic.c1_previous_display | default('—') }} | {{ doc_semantic.c1_trend_display }} |
| C2 — Scope/Mock coverage | {{ doc_semantic.c2_display }} | {{ doc_semantic.c2_previous_display | default('—') }} | {{ doc_semantic.c2_trend_display }} |
| C3 — Traceability accuracy | {{ doc_semantic.c3_display }} | {{ doc_semantic.c3_previous_display | default('—') }} | {{ doc_semantic.c3_trend_display }} |
...
|---:|---|:---:|---:|---:|---|
| 1 | Scope | **required** | {{ sections.scope.det_score }} / 100 | {{ sections.scope.det_previous_score | default('—') }} | {{ sections.scope.det_trend_display }} |
| 2 | Mock APIs | **required** | {{ sections.mock_apis.det_score }} / 100 | {{ sections.mock_apis.det_previous_score | default('—') }} | {{ sections.mock_apis.det_trend_display }} |
| 3 | Data Model | **required** | {{ sections.data_model.det_score }} / 100 | {{ sections.data_model.det_previous_score | default('—') }} | {{ sections.data_model.det_trend_display }} |
...
| 5 | Constraints | optional | {{ sections.constraints.det_score }} / 100 | {{ sections.constraints.det_previous_score | default('—') }} | {{ sections.constraints.det_trend_display }} |
| 6 | Traceability | optional | {{ sections.traceability.det_score }} / 100 | {{ sections.traceability.det_previous_score | default('—') }} | {{ sections.traceability.det_trend_display }} |

### Semantic — Section (`audit/semantic/section/11-prototype/*.md`)

| # | Section | Required | Score | Previous | Trend |
|---:|---|:---:|---:|---:|---|
| 1 | Scope | **required** | {{ sections.scope.sem_score }} / 100 | {{ sections.scope.sem_previous_score | default('—') }} | {{ sections.scope.sem_trend_display }} |
| 2 | Mock APIs | **required** | {{ sections.mock_apis.sem_score }} / 100 | {{ sections.mock_apis.sem_previous_score | default('—') }} | {{ sections.mock_apis.sem_trend_display }} |
| 3 | Data Model | **required** | {{ sections.data_model.sem_score }} / 100 | {{ sections.data_model.sem_previous_score | default('—') }} | {{ sections.data_model.sem_trend_display }} |
...
| 5 | Constraints | optional | {{ sections.constraints.sem_score }} / 100 | {{ sections.constraints.sem_previous_score | default('—') }} | {{ sections.constraints.sem_trend_display }} |
| 6 | Traceability | optional | {{ sections.traceability.sem_score }} / 100 | {{ sections.traceability.sem_previous_score | default('—') }} | {{ sections.traceability.sem_trend_display }} |
...
| Report | File |
|---|---|
| Deterministic — Whole | `{{ det_whole_report_path }}` (`audit/deterministic/document/11-prototype.yaml`) |
| Deterministic — Section | `{{ det_section_report_path }}` (`audit/deterministic/section/11-prototype/*.yaml`) |
| Semantic — Whole | `{{ sem_whole_report_path }}` (`audit/semantic/document/11-prototype.md`) |
| Semantic — Section | `{{ sem_section_report_path }}` (`audit/semantic/section/11-prototype/*.md`) |
