...
### Deterministic — Whole (`audit/deterministic/document/13-implementation.yaml`)
...
### Semantic — Whole (`audit/semantic/document/13-implementation.md`)
...
| Report | File |
|---|---|
| Deterministic — Whole | `{{ det_whole_report_path }}` (`audit/deterministic/document/13-implementation.yaml`) |
| Deterministic — Section | `{{ det_section_report_path }}` (`audit/deterministic/section/13-implementation/*.yaml`) |
| Semantic — Whole | `{{ sem_whole_report_path }}` (`audit/semantic/document/13-implementation.md`) |
| Semantic — Section | `{{ sem_section_report_path }}` (`audit/semantic/section/13-implementation/*.md`) |
