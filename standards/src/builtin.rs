...
use schemas::standard::{RequiredSection, AuditRuleDef, StandardRelationship};
...
fn readme_standard() -> StandardDefinition {
    StandardDefinition {
        ...
        required_sections: vec![
            section("Title", "Repository name and brief description", true, false),
            section("Getting Started", "Installation and basic usage", true, false),
...
fn philosophy_standard() -> StandardDefinition {
    StandardDefinition {
        ...
        required_sections: vec![
            section("Principles", "Core design and engineering principles", true, false),
...
fn architecture_standard() -> StandardDefinition {
    StandardDefinition {
        ...
        required_sections: vec![
            section("System Overview", "High-level system description", true, false),
            section("Component Model", "Components and responsibilities", true, false),
            section("Communication", "How components communicate", true, false),
            section("Data Flow", "How data moves through the system", true, false),
...
fn feature_standard() -> StandardDefinition {
    StandardDefinition {
        ...
        required_sections: vec![
            ...
            section("Acceptance Criteria", "How to verify completion", true, false),
        ],
...
fn feature_design_standard() -> StandardDefinition {
    StandardDefinition {
        ...
        required_sections: vec![
            section("User Experience", "How users interact with the feature", true, false),
            section("Workflow", "Step-by-step user workflow", true, false),
            section("States", "Empty, loading, success, error states", true, false),
        ],
...
fn feature_technical_standard() -> StandardDefinition {
    StandardDefinition {
        ...
        required_sections: vec![
            section("Participating Components", "Which components are involved", true, false),
            section("Component Interactions", "How components interact", true, false),
            section("Data Ownership", "Who owns what data", true, false),
            section("Security Considerations", "Security implications", true, false),
        ],
...
fn engineering_standard() -> StandardDefinition {
    StandardDefinition {
        ...
        required_sections: vec![
            section("Engineering Principles", "Core engineering principles", true, false),
            section("Technology Selection", "Why technologies were chosen", true, false),
            section("Build Standards", "How the project is built", true, false),
            section("Testing Standards", "How the project is tested", true, false),
        ],
...
fn external_context_standard() -> StandardDefinition {
    StandardDefinition {
        ...
        required_sections: vec![
            ...
            section("Constraints", "Constraints imposed by dependency", true, false),
        ],
